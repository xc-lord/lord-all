...
/**
 * 扩展属性sys_extend_attr的动态SQL拼装工具类
 *
 * @author xiaocheng
 * @version 1.0
 * @Date 2018年05月09日 18:08:35
 */
public class SysExtendAttrSpecs extends BaseSpecification {
     ...
     * @return
     */
    public static Specification<SysExtendAttr> queryBySysExtendAttr(final SysExtendAttr pageObj) {
        return new Specification<SysExtendAttr>() {
            public Predicate toPredicate(Root<SysExtendAttr> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
                Path id = root.get("id");
