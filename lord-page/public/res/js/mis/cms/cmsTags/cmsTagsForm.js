...
var CmsTagsFromCommon = {
            ...
            name: [
                {required: true, message: '名称不能为空', trigger: 'blur'},
                {
                    validator: function(rule, value, callback){
                        return commonUtils.formRowIsExist('/api/admin/cms/cmsTags/isExist.do',"name",rule, value, callback);
                    },
                    trigger: 'blur'
                }
            ],
    ...
    saveAction: function (_self) {
        ...
        $.ajax({
            ...
            if (res.success) {
                ...
                window.location.href = "#/cmsTags";//跳转到列表页面
    ...
    closeDialogForm:function() {
		//如果是弹窗模式，关闭弹窗
        if(typeof(cmsTagsView) !== 'undefined' && cmsTagsView.dialogFormVisible) {			
			cmsTagsView.dialogFormClose();
		}
    }
};