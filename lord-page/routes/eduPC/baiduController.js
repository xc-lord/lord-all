(function() {
    ...
    router.get('/baidu/getKRByQuery', function (req, res, next) {
    ...
    router.get('/baidu/getKRFileIdByWords', function (req, res, next) {
        var query = req.query.query;
        if(!query)
            query = ["nodejs"];
        else
    ...
    router.get('/baidu/getFilePath', function (req, res, next) {
